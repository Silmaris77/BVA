...
# json.dumps ensures proper escaping of newlines and quotes
branza_json = json.dumps(branza_text, ensure_ascii=False) # RETURNS "text..." with quotes
ryzyko_json = json.dumps(ryzyko_text, ensure_ascii=False)

# One-liner JSON structure to prevent any physical newline injection
...
print("Done. v10 created with json.dumps.")
