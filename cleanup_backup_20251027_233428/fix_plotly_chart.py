"""Fix plotly_chart width parameter deprecation"""
import os
import re
from pathlib import Path

def fix_file(filepath):
    """Replace width parameter with use_container_width in plotly_chart"""
    try:
        ...
        if 'st.plotly_chart(' not in content or 'width=' not in content:
            return False
