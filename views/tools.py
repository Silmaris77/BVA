...
def show_autodiagnosis():
    ...
    with col1:
        ...
        if zen_button("▶️ Rozpocznij Test Neurolidera", key="neuroleader_test", width='stretch'):
...
def generate_kolb_html_report() -> str:
    ...
    ability_info = {
        "CE": {"name": "Konkretne Doświadczenie", "emoji": "🎯", "color": "#E74C3C", "desc": "Feeling"},
        ...
        with st.container():
            ...
            <div style='padding: 20px; border: 2px solid #E91E63; border-radius: 15px; margin: 10px 0; background: linear-gradient(135deg, #ffeef8 0%, #f8bbd9 100%);'>
                ...
                <ul style='margin: 10px 0; padding-left: 20px;'>
                    ...
                    <li>✅ Ostrzeżenia o eskalacji problemów</li>
...
def analyze_conversation_level(text: str) -> Optional[Dict]:
    ...
    if hasattr(evaluator, 'demo_mode') and evaluator.demo_mode:
        st.info("💡 C-IQ Scanner w trybie demo - używam analizy heurystycznej")
...
def show_escalation_monitoring():
    ...
    st.markdown("### 🎯 Wykrywanie Sygnałów Problemów Zespołowych")
    ...
    with col1:
        ...
        <div style='padding: 20px; border: 2px solid #9C27B0; border-radius: 15px; margin: 10px 0; background: linear-gradient(135deg, #f3e5f5 0%, #ce93d8 100%);'>
            ...
            <ul style='margin: 10px 0; padding-left: 20px;'>
                ...
                <li>✅ 3 poziomy trudności (łatwy/średni/trudny)</li>
...
def display_leadership_profile(profile: Dict):
    ...
    if level_iii < 30:
        st.warning("⚠️ **Prioritet:** Zwiększ używanie poziomu III - zadawaj więcej pytań otwartych, słuchaj aktywnie, współtwórz rozwiązania")
    elif level_iii < 50:
...
def display_leadership_development_plan(profile: Dict):
    ...
    if level_iii_percentage < 30:
        st.warning(f"?? **Poziom III stanowi tylko {level_iii_percentage}%** Twojej komunikacji. To główny obszar rozwoju!")
    ...
    st.markdown("### 🔧 Plan rozwoju - najbliższe 3 miesiące")
...
def display_escalation_results(result: Dict):
    ...
    if 'warning_signals' in result:
        st.markdown("### 🎯 Wykryte sygnały ostrzegawcze")
