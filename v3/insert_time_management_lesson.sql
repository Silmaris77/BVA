-- SQL script to insert "Podstawy Zarządzania Czasem" lesson into Supabase
    ...
    '{
      "cards": [
        ...
        },
        {
          ...
          "examples": ["Manager spędza 80% czasu na emailach zamiast na rozwoju zespołu", "CEO cały dzień w spotkaniach - brak czasu na myślenie strategiczne", "Handlowiec obsługuje kryzys zamiast dzwonić do nowych klientów"],
        ...
        },
        {
          ...
          "data": {"framework": "eisenhower_matrix", "quadrants": {"q1": {"name": "Kryzys", "attributes": ["pilne", "ważne"], "action": "Rób natychmiast", "target_time": "0-25%"}, "q2": {"name": "Strategia", "attributes": ["nie_pilne", "ważne"], "action": "Zaplanuj i rób regularnie", "target_time": "50-75%"}, "q3": {"name": "Dystrakcje", "attributes": ["pilne", "nie_ważne"], "action": "Deleguj lub ogranicz", "target_time": "0-15%"}, "q4": {"name": "Strata czasu", "attributes": ["nie_pilne", "nie_ważne"], "action": "Eliminuj", "target_time": "0%"}}},
        ...
        },
        {
          "id": 4,
          "type": "question",
          "title": "Ćwiczenie: Klasyfikuj zadania 🎯",
          "question": "Przeczytaj poniższe zadania i przypisz je do odpowiednich kwadrantów Matrix Eisenhowera:",
          "quiz_type": "matching",
          "options": [{"id": "task1", "text": "Nauka nowego języka programowania", "correct_quadrant": "II"}, {"id": "task2", "text": "Spotkanie z klientem za 30 minut (umówione)", "correct_quadrant": "I"}, {"id": "task3", "text": "Przeglądanie LinkedIn bez celu", "correct_quadrant": "IV"}, {"id": "task4", "text": "Kolega prosi o pomoc w jego zadaniu", "correct_quadrant": "III"}],
          "explanation": "**Klucz:**\\n- Task 1 → Kwadrant II (Ważne, nie pilne - rozwój)\\n- Task 2 → Kwadrant I (Pilne i ważne - deadline)\\n- Task 3 → Kwadrant IV (Strata czasu)\\n- Task 4 → Kwadrant III (Pilne dla kogoś innego, nie dla Ciebie)",
          "estimated_seconds": 120,
          "xp_points": 15
        },
        {
          ...
          "data": {"technique": "pomodoro", "work_duration": 25, "short_break": 5, "long_break": 20, "cycles_before_long_break": 4},
        ...
        },
        {
          ...
          "action_items": ["Wybierz 1 narzędzie do GTD (Todoist, Notion, papier)", "Zaplanuj pierwszy blok Pomodoro na jutro rano", "Zidentyfikuj swoje główne zadanie Kwadrant II na ten tydzień"],
          "estimated_seconds": 120,
          "xp_points": 10
        },
        {
          ...
          "key_takeaways": ["Kwadrant II to klucz do długoterminowego sukcesu", "Pomodoro = 25 min skupienia + 5 min przerwy", "GTD: Capture → Clarify → Organize → Reflect → Engage"],
