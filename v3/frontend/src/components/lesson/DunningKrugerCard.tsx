...
export default function DunningKrugerCard({
    ...
    return (
        <div className="w-full max-w-5xl mx-auto glass-card p-4 md:p-8 rounded-2xl border border-white/10 flex flex-col gap-6 relative overflow-hidden group">

            {/* Header */}
            <div className="text-center relative z-10 px-4">
                <h2 className="text-3xl font-black bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent mb-2 tracking-tight">
                    {title}
                </h2>
            ...
            {/* Chart Area */}
            <div className="relative w-full h-[300px] md:h-[350px] select-none z-10 my-2">
                {/* Axis Labels */}
